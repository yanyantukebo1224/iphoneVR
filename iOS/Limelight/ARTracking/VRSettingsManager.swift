...
class VRSettingsManager: ObservableObject {
    ...
    @Published var isFingerTrackingExperimentalEnabled: Bool {
        didSet { UserDefaults.standard.set(isFingerTrackingExperimentalEnabled, forKey: "vr_finger_tracking_exp_enabled") }
    }
    ...
    private init() {
        ...
        self.isFingerTrackingExperimentalEnabled = UserDefaults.standard.object(forKey: "vr_finger_tracking_exp_enabled") as? Bool ?? false
